...
class DD_net(nn.Module):
    def __init__(self):
        ...
        blocks.append(torchvision.models.vgg16(pretrained=True).features[17:24].eval()) # block 3
        blocks.append(torchvision.models.vgg16(pretrained=True).features[24:31].eval()) # block 4
        for bl in blocks:
