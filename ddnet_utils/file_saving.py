...
def init_vggloss_params():
    train_total_loss = defaultdict(list)
    train_MSSSIM_loss = defaultdict(list)
    train_MSE_loss = defaultdict(list)
    train_vgg_loss = defaultdict(list)

    val_MSE_loss = defaultdict(list)
    val_total_loss = defaultdict(list)
    val_MSSSIM_loss = defaultdict(list)
    val_vgg_loss = defaultdict(list)

    return train_total_loss,train_MSSSIM_loss,train_MSE_loss, train_vgg_loss, val_total_loss, val_MSSSIM_loss,val_MSE_loss,val_vgg_loss
